...
public class SheriffDebug : MonoBehaviour
{
    private void OnDrawGizmos()
    {
        ...
        Vector3 angleThree = DirectionFromAngleY(-transform.eulerAngles.y, -GetComponent<SheriffVision>().detectionAngle * 0.5f);
        Vector3 angleFour = DirectionFromAngleY(-transform.eulerAngles.y, GetComponent<SheriffVision>().detectionAngle * 0.5f);
        ...
        Gizmos.DrawLine(transform.position, transform.position + angleThree * GetComponent<SheriffVision>().visionRange);
        Gizmos.DrawLine(transform.position, transform.position + angleFour * GetComponent<SheriffVision>().visionRange);
